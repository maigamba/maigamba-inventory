-- AlterTable
ALTER TABLE "users" ALTER COLUMN "role" SET DEFAULT 'Sales Staff';
...
-- CreateIndex
CREATE UNIQUE INDEX "user_permissions_user_permission_id_key" ON "user_permissions"("user_permission_id");
