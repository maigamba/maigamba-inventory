...
export const ProductsView: React.FC = () => {
  ...
  // Normalize reference lists returned by either the legacy UI shape or Prisma camelCase.
  ...
  const normalizedFilterBrands = useMemo(
    () =>
  ...
  const filteredProducts = useMemo(() => {
    return products.filter((p) => {
      ...
      // Category
      const matchCat = selectedCategory === 'ALL' || String(p.CategoryID ?? (p as any).categoryId ?? '') === selectedCategory;

      // Brand
      const matchBrand = selectedBrand === 'ALL' || String(p.BrandID ?? (p as any).brandId ?? '') === selectedBrand;
    ...
    <div className="min-h-full bg-slate-50/70" >
      <div className="mx-auto max-w-[1600px] p-4 sm:p-6 lg:p-8 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2">
          <div>
            <span className="text-[11px] font-semibold uppercase tracking-[0.18em] text-blue-600 block mb-1">
              Products & Inventory
            </span>
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <button
              ...
              className="p-2 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-slate-900 shadow-sm transition-colors cursor-pointer"
            ...
            <button
              ...
              className="px-3.5 py-2 border border-slate-200 hover:border-slate-900 bg-white hover:bg-slate-50 text-slate-900 rounded-xl text-xs uppercase tracking-wider font-semibold flex items-center gap-1.5 transition-colors cursor-pointer"
            ...
            <button
              ...
              className="px-3.5 py-2 border border-slate-200 hover:border-slate-900 bg-slate-100 hover:bg-[#eae4d9] text-slate-900 rounded-xl text-xs uppercase tracking-wider font-semibold flex items-center gap-1.5 transition-colors cursor-pointer"
            ...
            <button
              ...
              className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-xl shadow-sm flex items-center gap-2 transition-all cursor-pointer"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div
            ...
            className={`bg-white p-5 border border-slate-200 rounded-2xl transition-all duration-200 flex flex-col justify-between stat-card-flop cursor-pointer shadow-sm hover:-translate-y-0.5 hover:shadow-md ${stockStatusFilter === 'ALL' ? 'border-slate-900 ring-1 ring-black/10' : 'border-slate-200 hover:border-slate-300'
              }`}
          >
            <div className="flex items-center justify-between">
              <span className="text-[11px] uppercase tracking-wider text-slate-500 font-semibold">Catalog Volume</span>
              <div className="p-1.5 border border-slate-200 bg-slate-50 text-slate-700">
                <Package className="w-4 h-4" />
              </div>
            </div>
            <div className="mt-3">
              <h3 className="text-2xl font-bold tracking-tight text-slate-950">{productStats.totalItems}</h3>
              <p className="text-[11px] text-slate-400 mt-1">Total hardware items</p>
            </div>
          </div>
          ...
          <div
            ...
            className={`bg-white p-5 border border-slate-200 rounded-2xl transition-all duration-200 flex flex-col justify-between stat-card-flop cursor-pointer shadow-sm hover:-translate-y-0.5 hover:shadow-md ${stockStatusFilter === 'IN_STOCK' ? 'border-emerald-700 ring-1 ring-emerald-600/30' : 'border-slate-200 hover:border-slate-300'
              }`}
          >
            <div className="flex items-center justify-between">
              <span className="text-[11px] uppercase tracking-wider text-slate-500 font-semibold">Nominal Stock</span>
              <div className="p-1.5 border border-emerald-200 bg-emerald-50 text-emerald-800">
                <CheckCircle2 className="w-4 h-4" />
              </div>
            </div>
            <div className="mt-3">
              <h3 className="text-2xl font-sans text-emerald-800 tracking-tight">{productStats.inStock}</h3>
              <p className="text-[11px] text-slate-400 mt-1">Above reorder limits</p>
            </div>
          </div>
          ...
          <div
            ...
            className={`bg-white p-5 border border-slate-200 rounded-2xl transition-all duration-200 flex flex-col justify-between stat-card-flop cursor-pointer shadow-sm hover:-translate-y-0.5 hover:shadow-md ${stockStatusFilter === 'LOW_STOCK' ? 'border-amber-700 ring-1 ring-amber-600/30' : 'border-slate-200 hover:border-slate-300'
              }`}
          >
            <div className="flex items-center justify-between">
              <span className="text-[11px] uppercase tracking-wider text-slate-500 font-semibold">Reorder Alert</span>
              <div className="p-1.5 border border-amber-200 bg-amber-50 text-amber-800">
                <AlertTriangle className="w-4 h-4 text-amber-800" />
              </div>
            </div>
            <div className="mt-3">
              <h3 className="text-2xl font-sans text-amber-900 tracking-tight">{productStats.lowStock}</h3>
              <p className="text-[11px] text-slate-400 mt-1">Near threshold minimum</p>
            </div>
          </div>
          ...
          <div
            ...
            className={`bg-white p-5 border border-slate-200 rounded-2xl transition-all duration-200 flex flex-col justify-between stat-card-flop cursor-pointer shadow-sm hover:-translate-y-0.5 hover:shadow-md ${stockStatusFilter === 'OUT_OF_STOCK' ? 'border-rose-700 ring-1 ring-rose-600/30' : 'border-slate-200 hover:border-slate-300'
              }`}
          >
            <div className="flex items-center justify-between">
              <span className="text-[11px] uppercase tracking-wider text-slate-500 font-semibold">Depleted Stock</span>
              <div className="p-1.5 border border-rose-200 bg-rose-50 text-rose-800">
                <ShieldAlert className="w-4 h-4 text-rose-700" />
              </div>
            </div>
            <div className="mt-3">
              <h3 className="text-2xl font-sans text-rose-800 tracking-tight">{productStats.outOfStock}</h3>
              <p className="text-[11px] text-slate-400 mt-1">Zero quantity on hand</p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
            ...
            <div className="relative lg:col-span-2">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 text-slate-900"
              />
            </div>
            ...
            <div>
              <select
                ...
                className="w-full py-2 px-3 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 text-slate-900"
              >
                <option value="ALL">All Categories</option>
                {normalizedFilterCategories.map((c: any) => (
            ...
            <div>
              ...
              >
                ...
                {normalizedFilterBrands.map((b: any) => (
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                {isProductsLoading && products.length === 0 ? (
                  ...
                  <tr>
                    <td colSpan={12} className="py-12 text-center text-slate-400">
                      ...
                      <p className="font-sans font-bold text-base text-slate-900">No products found</p>
                      <p className="text-[11px] text-slate-400 font-light mt-1">Try resetting filters or click "Add New Product" to create one.</p>
                    </td>
                  </tr>
                ) : (
                  paginatedProducts.map((p) => {
                    ...
                    return (
                      <tr key={p.ProductID} className="hover:bg-slate-50/80 transition-colors group">
                        <td className="py-3 px-4 font-mono font-medium text-slate-900">{p.SKU}</td>
                          ...
                          <div className="flex items-center gap-3">
                            <div className="relative group/thumb shrink-0">
                              <img
                                ...
                                className="w-10 h-10 rounded-xl object-cover border border-slate-200 bg-slate-100 group-hover:scale-105 transition-transform"
                              />
                              <button
                                type="button"
                                onClick={() => {
                                ...
                                className="absolute inset-0 bg-slate-950/50 opacity-0 group-hover/thumb:opacity-100 flex items-center justify-center rounded-xl text-amber-300 transition-opacity cursor-pointer"
                        ...
                        <td className="py-3 px-4 text-slate-500 font-light">{getCategoryName(p.CategoryID)}</td>
                        <td className="py-3 px-4 text-slate-500 font-light">{getBrandName(p.BrandID)}</td>
                        <td className="py-3 px-4 text-slate-400 font-light">{p.Model || '—'}</td>
                        ...
                        <td className="py-3 px-4 font-sans text-slate-500">{formatCurrency(p.CostPrice)}</td>
                        <td className="py-3 px-4 font-sans font-bold text-slate-900">{formatCurrency(p.SellingPrice)}</td>
                        <td className="py-3 px-4 text-slate-400 font-light">{getSupplierName(p.SupplierID)}</td>
                        <td className="py-3 px-4 text-slate-400 font-light">{p.Location || 'Main Store'}</td>
                        <td className="py-3 px-4">
                          <span
          ...
          {filteredProducts.length > 0 && (
            <div className="p-3.5 border-t border-slate-200 bg-[#fcfaf7] flex items-center justify-between text-xs text-slate-400 font-light">
              <span>
              ...
              <div className="flex items-center gap-1.5">
                <button
                  ...
                  className="px-3 py-1 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-slate-900 text-[10px] uppercase tracking-wider font-semibold disabled:opacity-30 transition-colors"
                >
                  Previous
                </button>
                <span className="px-2 font-mono text-xs font-semibold text-slate-900">
        ...
        {isAddModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/50 backdrop-blur-xs overflow-y-auto">
            <div className="w-full max-w-2xl bg-white rounded-xl shadow-2xl border border-slate-900/20 overflow-hidden my-8">
              <div className="p-6 border-b border-slate-200 bg-[#fcfaf7] flex items-center justify-between">
              ...
              <form onSubmit={handleSaveProduct} className="p-6 space-y-4">
                ...
                <div className="p-4 bg-[#fcfaf7] border border-slate-200 rounded-xl flex flex-col sm:flex-row items-center gap-4">
                  <div className="relative group shrink-0">
                    ...
                    {formData.ProductImage && (
                      <button
                        ...
                        className="absolute -top-1.5 -right-1.5 w-5 h-5 bg-rose-600 text-white rounded-full flex items-center justify-center text-xs hover:bg-rose-700 shadow-sm cursor-pointer"
                  ...
                  <div className="flex-1 min-w-0 space-y-1.5 text-center sm:text-left">
                    ...
                    <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 pt-1">
                      <button
                        ...
                        className="px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-[10px] uppercase tracking-wider font-semibold flex items-center gap-1.5 shadow-sm transition-colors cursor-pointer"
                      >
                        <Camera className="w-3.5 h-3.5 text-amber-300" />
                        <span>Snap with Camera</span>
                      </button>

                      <label className="px-3 py-1.5 border border-slate-200 hover:border-slate-900 bg-white hover:bg-slate-50 text-slate-900 rounded-xl text-[10px] uppercase tracking-wider font-semibold flex items-center gap-1.5 transition-colors cursor-pointer">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {/* SKU */}
                  <div>
                    <label className="block text-[10px] font-semibold text-slate-500 uppercase tracking-[0.15em] mb-1">
                      SKU Code *
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full p-2.5 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 font-mono text-slate-900"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-2.5 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 text-slate-900"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full p-2.5 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 text-slate-900 disabled:opacity-60"
                    >
                      <option value="">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-2.5 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 font-mono font-bold text-slate-900"
                    />
                  </div>
                ...
                <div className="pt-4 border-t border-slate-200 flex items-center justify-end gap-2.5">
                  <button
                    ...
                    className="px-4 py-2 text-[10px] uppercase tracking-wider font-semibold text-slate-700 bg-slate-100 hover:bg-black/10 rounded-xl transition-colors"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    disabled={isSubmittingForm}
                    className="px-5 py-2 text-[10px] uppercase tracking-wider font-semibold text-[#fcfaf7] bg-[#1a1a1a] hover:bg-black rounded-xl shadow-sm flex items-center gap-2 transition-all disabled:opacity-50"
                  >
                    {isSubmittingForm ? (
                      <>
        ...
        {adjustingProduct && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/50 backdrop-blur-xs">
            <div className="w-full max-w-md bg-white rounded-xl shadow-2xl border border-slate-900/20 overflow-hidden">
              <div className="p-5 border-b border-slate-200 bg-[#fcfaf7] flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  <div className="p-1.5 rounded-xl bg-[#1a1a1a] text-[#fcfaf7]">
                    <ArrowLeftRight className="w-4 h-4" />
                  </div>
                  <div>
                    <h3 className="text-sm font-sans font-bold text-slate-900">Adjust Product Stock</h3>
                    <p className="text-[11px] text-slate-400 truncate max-w-[240px] font-light">
                ...
                <button
                  ...
                  className="text-slate-400 hover:text-slate-900 p-1 rounded-xl hover:bg-slate-100"
                >
                  <X className="w-4 h-4" />
                </button>
              </div>
              ...
              <form onSubmit={handleAdjustSubmit} className="p-5 space-y-4">
                ...
                <div className="p-3 rounded-xl bg-[#fcfaf7] border border-slate-200 flex items-center justify-between text-xs">
                  <div>
                    <span className="text-slate-400 font-light">Current Stock:</span>
                    <p className="text-base font-sans font-bold text-slate-900">{parseNumber(adjustingProduct.Quantity)} units</p>
                  </div>
                  <div className="text-right">
                    <span className="text-slate-400 font-light">Calculated New Stock:</span>
                    <p className={`text-base font-sans font-bold ${adjustType === 'IN'
                      ? 'text-emerald-800'
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <button
                      ...
                      className={`py-2 text-[10px] uppercase tracking-wider font-semibold rounded-xl border transition-all ${adjustType === 'IN'
                        ? 'bg-[#1a1a1a] border-slate-900 text-[#fcfaf7] shadow-sm'
                    ...
                    <button
                      ...
                      className={`py-2 text-[10px] uppercase tracking-wider font-semibold rounded-xl border transition-all ${adjustType === 'OUT'
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2.5 text-sm font-sans font-bold bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 text-slate-900"
                  />
                </div>
                ...
                <div className="pt-3 border-t border-slate-200 flex items-center justify-end gap-2.5">
                  <button
                    ...
                    className="px-4 py-2 text-[10px] uppercase tracking-wider font-semibold text-slate-700 bg-slate-100 hover:bg-black/10 rounded-xl"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    disabled={isSubmittingAdjust}
                    className="px-5 py-2 text-[10px] uppercase tracking-wider font-semibold text-[#fcfaf7] bg-[#1a1a1a] hover:bg-black rounded-xl shadow-sm flex items-center gap-2"
                  >
        ...
        {viewingProduct && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/50 backdrop-blur-xs">
            <div className="w-full max-w-lg bg-white rounded-xl shadow-2xl border border-slate-900/20 overflow-hidden">
              <div className="p-6 border-b border-slate-200 bg-[#fcfaf7] flex items-center justify-between">
                <div>
                  <span className="text-[10px] font-mono text-slate-400 uppercase tracking-[0.2em] block mb-0.5">
                    {viewingProduct.SKU}
                  </span>
                  <h3 className="text-base font-sans font-bold text-slate-900">{viewingProduct.ProductName}</h3>
                </div>
                <button
              ...
              <div className="p-6 space-y-4 text-xs">
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3 rounded-xl bg-[#fcfaf7] border border-slate-200">
                    <span className="text-slate-400 text-[10px] uppercase tracking-wider block mb-0.5">Category</span>
                    <span className="font-medium text-slate-900">{getCategoryName(viewingProduct.CategoryID)}</span>
                  </div>
                  <div className="p-3 rounded-xl bg-[#fcfaf7] border border-slate-200">
                    <span className="text-slate-400 text-[10px] uppercase tracking-wider block mb-0.5">Brand</span>
                    <span className="font-medium text-slate-900">{getBrandName(viewingProduct.BrandID)}</span>
                  </div>
                  <div className="p-3 rounded-xl bg-[#fcfaf7] border border-slate-200">
                    <span className="text-slate-400 text-[10px] uppercase tracking-wider block mb-0.5">Current Stock</span>
                    <span className="font-sans font-bold text-slate-900 text-sm">{viewingProduct.Quantity} Units</span>
                  </div>
                  <div className="p-3 rounded-xl bg-[#fcfaf7] border border-slate-200">
                    <span className="text-slate-400 text-[10px] uppercase tracking-wider block mb-0.5">Reorder Limit</span>
                    <span className="font-sans font-medium text-slate-900">{viewingProduct.ReorderLevel ?? 5} Units</span>
                  </div>
                  <div className="p-3 rounded-xl bg-[#fcfaf7] border border-slate-200">
                    <span className="text-slate-400 text-[10px] uppercase tracking-wider block mb-0.5">Cost Price</span>
                    <span className="font-sans font-medium text-slate-700">{formatCurrency(viewingProduct.CostPrice)}</span>
                  </div>
                  <div className="p-3 rounded-xl bg-[#fcfaf7] border border-slate-200">
                    <span className="text-slate-400 text-[10px] uppercase tracking-wider block mb-0.5">Selling Price</span>
                    <span className="font-sans font-bold text-slate-900 text-sm">{formatCurrency(viewingProduct.SellingPrice)}</span>
                  </div>
                  <div className="p-3 rounded-xl bg-[#fcfaf7] border border-slate-200">
                    <span className="text-slate-400 text-[10px] uppercase tracking-wider block mb-0.5">Supplier</span>
                    <span className="font-medium text-slate-900">{getSupplierName(viewingProduct.SupplierID)}</span>
                  </div>
                  <div className="p-3 rounded-xl bg-[#fcfaf7] border border-slate-200">
                    <span className="text-slate-400 text-[10px] uppercase tracking-wider block mb-0.5">Location</span>
                    <span className="font-medium text-slate-900">{viewingProduct.Location || 'Main Store'}</span>
                  </div>
                </div>

                {viewingProduct.Description && (
                  <div className="p-3 rounded-xl bg-[#fcfaf7] border border-slate-200">
                    <span className="text-slate-400 text-[10px] uppercase tracking-wider block mb-1">Specifications & Description</span>
                    <p className="text-slate-700 leading-relaxed font-light">{viewingProduct.Description}</p>
                  </div>
                )}
                ...
                <div className="pt-2 flex justify-end">
                  <button
                    type="button"
                    onClick={() => setViewingProduct(null)}
                    className="px-4 py-2 bg-slate-100 hover:bg-black/10 text-slate-900 font-semibold rounded-xl text-[10px] uppercase tracking-wider"
                  >
                    Close
                  </button>
                </div>
